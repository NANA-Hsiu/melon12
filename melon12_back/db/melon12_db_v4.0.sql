...
-- ----------------------------
-- Table structure for t_BaseData_Table
-- ----------------------------
DROP TABLE IF EXISTS `t_BaseData_Table`;
CREATE TABLE `t_BaseData_Table` (
  `data_id` integer(6) not null auto_increment,
  `type` varchar(10) NOT NULL DEFAULT '',
  `variety` varchar(20) NOT NULL DEFAULT '',
